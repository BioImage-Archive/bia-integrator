...
def load_submission(accession_id: str) -> Submission:
    ...
    overrides = {
        ...
        "S-BIAD1261": "Author had no name, and the email was for a whole lab. Affiliation name was used instead of author name",
        ...
        "S-BIAD1136": "invalid email: oona.paavolainen@ut changed to: oona.paavolainen@utu.fi (same ending as other authors)",
        "S-BIAD1223": "invalid email: ylva.ivarsson@kemi..u.se changed to: ylva.ivarsson@kemi.u.se",
