...
def get_image_with_one_file_reference() -> bia_data_model.Image:
    ...
    creation_process_uuid = uuid_creation.create_creation_process_uuid(
        study_uuid, unique_string=f"{image_dict['uuid']}",
    )
    ...
    image_dict["additional_metadata"].append(attribute_models.DocumentUUIDUinqueInputAttribute.model_validate(uuid_unique_input_dict))
