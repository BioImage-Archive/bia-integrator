...
def get_creation_process_with_one_file_reference() -> bia_data_model.CreationProcess:
    ...
    creation_process_dict["uuid"] = uuid_creation.create_creation_process_uuid(input_image_uuid)
    # TODO: Check with FR if this should be a list - i.e. 1-many relationship with image
    creation_process_dict["input_image_uuid"] = [input_image_uuid,]
