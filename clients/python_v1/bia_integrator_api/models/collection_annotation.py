...
class CollectionAnnotation(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CollectionAnnotation:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CollectionAnnotation:
        """Create an instance of CollectionAnnotation from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CollectionAnnotation.parse_obj(obj)

        _obj = CollectionAnnotation.parse_obj({
