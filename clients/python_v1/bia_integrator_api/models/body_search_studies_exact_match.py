...
class BodySearchStudiesExactMatch(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BodySearchStudiesExactMatch:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BodySearchStudiesExactMatch:
        """Create an instance of BodySearchStudiesExactMatch from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BodySearchStudiesExactMatch.parse_obj(obj)

        _obj = BodySearchStudiesExactMatch.parse_obj({
