...
class BodySearchFileReferencesExactMatch(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BodySearchFileReferencesExactMatch:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BodySearchFileReferencesExactMatch:
        """Create an instance of BodySearchFileReferencesExactMatch from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BodySearchFileReferencesExactMatch.parse_obj(obj)

        _obj = BodySearchFileReferencesExactMatch.parse_obj({
