...
class SearchFileRepresentation(BaseModel):
    ...
    __properties = ["size_bounds_lte", "size_bounds_gte", "type", "uri_prefix"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SearchFileRepresentation:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SearchFileRepresentation:
        """Create an instance of SearchFileRepresentation from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SearchFileRepresentation.parse_obj(obj)

        _obj = SearchFileRepresentation.parse_obj({
