# openapi_client.model.file_reference.FileReference
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | A reference to an externally hosted file. | 
...
**study_id** | str,  | str,  |  | 
**uri** | str,  | str,  |  | 
**size_bytes** | decimal.Decimal, int,  | decimal.Decimal,  |  | [optional] 
