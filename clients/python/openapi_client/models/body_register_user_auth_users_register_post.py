...
class BodyRegisterUserAuthUsersRegisterPost(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BodyRegisterUserAuthUsersRegisterPost:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BodyRegisterUserAuthUsersRegisterPost:
        """Create an instance of BodyRegisterUserAuthUsersRegisterPost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BodyRegisterUserAuthUsersRegisterPost.parse_obj(obj)

        _obj = BodyRegisterUserAuthUsersRegisterPost.parse_obj({
            "email": obj.get("email"),
