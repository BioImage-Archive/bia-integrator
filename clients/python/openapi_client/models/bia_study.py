...
class BIAStudy(BaseModel):
    ...
    __properties = ["_id", "uuid", "version", "model", "title", "description", "authors", "organism", "release_date", "accession_id", "imaging_type", "attributes", "annotations", "example_image_uri", "example_image_annotation_uri", "tags", "file_references_count", "images_count"]
