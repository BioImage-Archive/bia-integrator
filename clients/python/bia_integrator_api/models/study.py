...
class Study(BaseModel):
    ...
    grant: Optional[List[Grant]] = Field(
        default=None, description="The grants that funded the study."
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.funding_statement is None
            and "funding_statement" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "author": [Contributor.from_dict(_item) for _item in obj["author"]]
                ...
                "see_also": [
                    ExternalReference.from_dict(_item) for _item in obj["see_also"]
                ]
                if obj.get("see_also") is not None
                else None,
                "related_publication": [
                    Publication.from_dict(_item) for _item in obj["related_publication"]
                ]
                if obj.get("related_publication") is not None
                else None,
                "grant": [Grant.from_dict(_item) for _item in obj["grant"]]
