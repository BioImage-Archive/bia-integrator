...
class Study(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["uuid", "object_creator", "version", "model", "additional_metadata", "accession_id", "licence", "author", "title", "release_date", "description", "keyword", "acknowledgement", "see_also", "related_publication", "grant", "funding_statement"]
