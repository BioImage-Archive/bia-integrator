...
class ImageAcquisitionAnnotation(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ImageAcquisitionAnnotation:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ImageAcquisitionAnnotation:
        """Create an instance of ImageAcquisitionAnnotation from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ImageAcquisitionAnnotation.parse_obj(obj)

        _obj = ImageAcquisitionAnnotation.parse_obj({
