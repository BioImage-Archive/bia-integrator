...
class DerivedImage(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["uuid", "version", "model", "attribute", "transformation_description", "spatial_information", "source_image_uuid", "submission_dataset_uuid", "creation_process_uuid"]
