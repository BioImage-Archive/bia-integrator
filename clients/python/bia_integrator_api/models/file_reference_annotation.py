...
class FileReferenceAnnotation(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FileReferenceAnnotation:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FileReferenceAnnotation:
        """Create an instance of FileReferenceAnnotation from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FileReferenceAnnotation.parse_obj(obj)

        _obj = FileReferenceAnnotation.parse_obj({
