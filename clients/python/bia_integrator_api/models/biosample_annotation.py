...
class BiosampleAnnotation(BaseModel):
    """
    BiosampleAnnotation
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BiosampleAnnotation:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BiosampleAnnotation:
        """Create an instance of BiosampleAnnotation from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BiosampleAnnotation.parse_obj(obj)

        _obj = BiosampleAnnotation.parse_obj({
