...
class BIAImageRepresentation(BaseModel):
    ...
    """ # noqa: E501
    size: StrictInt
    uri: Optional[List[StrictStr]] = None
    type: Optional[StrictStr] = None
    dimensions: Optional[StrictStr] = None
    attributes: Optional[Dict[str, Any]] = None
    rendering: Optional[RenderingInfo] = None
    __properties: ClassVar[List[str]] = ["size", "uri", "type", "dimensions", "attributes", "rendering"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.rendering is None and "rendering" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rendering": RenderingInfo.from_dict(obj["rendering"]) if obj.get("rendering") is not None else None
        })
        return _obj
