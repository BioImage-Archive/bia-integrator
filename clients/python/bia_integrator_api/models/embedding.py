...
class Embedding(BaseModel):
    ...
    for_document_uuid: StrictStr
    additional_metadata: Dict[str, StrictStr]
    embedding_model: StrictStr
    __properties: ClassVar[List[str]] = ["uuid", "version", "model", "vector", "for_document_uuid", "additional_metadata", "embedding_model"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "for_document_uuid": obj.get("for_document_uuid"),
