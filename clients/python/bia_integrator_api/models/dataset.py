...
class Dataset(BaseModel):
    ...
    analysis_method: Optional[List[ImageAnalysisMethod]] = Field(
        default=None, description="Data analysis processes performed on the images."
    )
    correlation_method: Optional[List[ImageCorrelationMethod]] = Field(
        default=None, description="Processes performed to correlate image data."
    )
    example_image_uri: List[StrictStr] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "analysis_method": [
                    ImageAnalysisMethod.from_dict(_item)
                    for _item in obj["analysis_method"]
                ]
                if obj.get("analysis_method") is not None
                else None,
                "correlation_method": [
                    ImageCorrelationMethod.from_dict(_item)
                    for _item in obj["correlation_method"]
                ]
                if obj.get("correlation_method") is not None
                else None,
