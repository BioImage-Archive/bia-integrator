...
class Dataset(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["uuid", "object_creator", "version", "model", "additional_metadata", "title", "description", "analysis_method", "correlation_method", "example_image_uri", "submitted_in_study_uuid"]
