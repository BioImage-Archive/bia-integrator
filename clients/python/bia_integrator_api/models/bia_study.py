...
class BIAStudy(BaseModel):
    ...
    annotations: Optional[List[StudyAnnotation]] = None
    context: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default='https://raw.githubusercontent.com/BioImage-Archive/bia-integrator/main/api/src/models/jsonld/1.0/StudyContext.jsonld', alias="@context")
    uuid: StrictStr
    version: StrictInt
    ...
    __properties: ClassVar[List[str]] = ["attributes", "annotations_applied", "annotations", "@context", "uuid", "version", "model", "title", "description", "authors", "organism", "release_date", "accession_id", "imaging_type", "example_image_uri", "example_image_annotation_uri", "tags", "file_references_count", "images_count"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.imaging_type is None and "imaging_type" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "annotations": [StudyAnnotation.from_dict(_item) for _item in obj["annotations"]] if obj.get("annotations") is not None else None,
