...
class AnnotationData(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["object_creator", "uuid", "version", "model", "additional_metadata", "submission_dataset_uuid", "creation_process_uuid", "original_file_reference_uuid"]
