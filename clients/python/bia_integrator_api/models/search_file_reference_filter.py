...
class SearchFileReferenceFilter(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["annotations_any", "file_reference_match", "study_uuid", "start_uuid", "limit"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.file_reference_match is None and "file_reference_match" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "file_reference_match": SearchFileReference.from_dict(obj["file_reference_match"]) if obj.get("file_reference_match") is not None else None,
