...
class CreationProcess(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["uuid", "object_creator", "version", "model", "additional_metadata", "subject_specimen_uuid", "image_acquisition_protocol_uuid", "input_image_uuid", "protocol_uuid", "annotation_method_uuid"]
