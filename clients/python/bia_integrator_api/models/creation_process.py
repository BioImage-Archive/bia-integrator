...
class CreationProcess(BaseModel):
    ...
    image_acquisition_protocol_uuid: Optional[List[StrictStr]] = Field(default=None, description="The imaging protocol, describing the technique that was used to create the image.")
    input_image_uuid: Optional[List[StrictStr]] = Field(default=None, description="The images used as input data for the creation of a new image.")
    protocol_uuid: Optional[List[StrictStr]] = Field(default=None, description="A protocol which was followed that resulted in the creation of this new image from existing image data.")
    annotation_method_uuid: Optional[List[StrictStr]] = Field(default=None, description="The annotation method describing the process followed to create a new image from exsiting image data.")
    __properties: ClassVar[List[str]] = ["object_creator", "uuid", "version", "model", "additional_metadata", "subject_specimen_uuid", "image_acquisition_protocol_uuid", "input_image_uuid", "protocol_uuid", "annotation_method_uuid"]
