...
class ImageRepresentation(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["object_creator", "uuid", "version", "model", "additional_metadata", "image_format", "file_uri", "total_size_in_bytes", "voxel_physical_size_x", "voxel_physical_size_y", "voxel_physical_size_z", "size_x", "size_y", "size_z", "size_c", "size_t", "image_viewer_setting", "representation_of_uuid"]
