...
class ImageRepresentation(BaseModel):
    ...
    __properties: ClassVar[List[str]] = [
        ...
        "file_uri",
        "total_size_in_bytes",
        "voxel_physical_size_x",
        "voxel_physical_size_y",
        "voxel_physical_size_z",
        "size_x",
        "size_y",
        "size_z",
        "size_c",
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.voxel_physical_size_x is None
            and "voxel_physical_size_x" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.voxel_physical_size_y is None
            and "voxel_physical_size_y" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.voxel_physical_size_z is None
            and "voxel_physical_size_z" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "image_viewer_setting": [
                    RenderedView.from_dict(_item)
                    for _item in obj["image_viewer_setting"]
                ]
                if obj.get("image_viewer_setting") is not None
                else None,
