...
class BIAStudyOutput(BaseModel):
    """
    BIAStudyOutput
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BIAStudyOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BIAStudyOutput:
        """Create an instance of BIAStudyOutput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BIAStudyOutput.parse_obj(obj)

        _obj = BIAStudyOutput.parse_obj({
            "uuid": obj.get("uuid"),
