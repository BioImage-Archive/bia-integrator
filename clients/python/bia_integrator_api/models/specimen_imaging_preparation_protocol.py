    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.signal_channel_information:
            for _item_signal_channel_information in self.signal_channel_information:
                if _item_signal_channel_information:
                    _items.append(_item_signal_channel_information.to_dict())
            _dict["signal_channel_information"] = _items
        ...
        _obj = cls.model_validate(
            {
                ...
                "signal_channel_information": [
                    SignalChannelInformation.from_dict(_item)
                    for _item in obj["signal_channel_information"]
                ]
                if obj.get("signal_channel_information") is not None
                else None,
            }
        )
        return _obj
