...
class Image(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["uuid", "object_creator", "version", "model", "additional_metadata", "label", "submission_dataset_uuid", "creation_process_uuid", "original_file_reference_uuid"]
