...
class ImageAnnotationDataset(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["title_id", "uuid", "version", "model", "description", "attribute", "example_image_uri", "submitted_in_study_uuid"]
