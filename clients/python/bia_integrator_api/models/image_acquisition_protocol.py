...
class ImageAcquisitionProtocol(BaseModel):
    ...
    fbbi_id: Optional[List[StrictStr]] = Field(default=None, description="Biological Imaging Methods Ontology id indicating the kind of imaging that was perfomed.")
    imaging_method_name: Optional[List[StrictStr]] = Field(default=None, description="Name of the kind of imaging method that was performed.")
    __properties: ClassVar[List[str]] = ["uuid", "object_creator", "version", "model", "additional_metadata", "title", "protocol_description", "imaging_instrument_description", "fbbi_id", "imaging_method_name"]
