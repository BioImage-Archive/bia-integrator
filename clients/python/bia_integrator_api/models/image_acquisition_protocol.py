...
class ImageAcquisitionProtocol(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["object_creator", "uuid", "version", "model", "additional_metadata", "title", "protocol_description", "imaging_instrument_description", "fbbi_id", "imaging_method_name"]
