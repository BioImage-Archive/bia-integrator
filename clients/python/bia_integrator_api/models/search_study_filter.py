...
class SearchStudyFilter(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["annotations_any", "study_match", "start_uuid", "limit"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.study_match is None and "study_match" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "study_match": SearchStudy.from_dict(obj["study_match"]) if obj.get("study_match") is not None else None,
