...
class ExperimentallyCapturedImage(BaseModel):
    """
    ...
    subject_uuid: StrictStr
    __properties: ClassVar[List[str]] = ["uuid", "version", "model", "attribute", "acquisition_process_uuid", "submission_dataset_uuid", "subject_uuid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "acquisition_process_uuid": obj.get("acquisition_process_uuid"),
            "submission_dataset_uuid": obj.get("submission_dataset_uuid"),
            "subject_uuid": obj.get("subject_uuid")
        })
        return _obj
