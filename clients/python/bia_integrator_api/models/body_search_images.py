...
class BodySearchImages(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BodySearchImages:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BodySearchImages:
        """Create an instance of BodySearchImages from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BodySearchImages.parse_obj(obj)

        _obj = BodySearchImages.parse_obj({
