...
class Grant(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in funder (list)
        _items = []
        if self.funder:
            for _item_funder in self.funder:
                if _item_funder:
                    _items.append(_item_funder.to_dict())
            _dict['funder'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "funder": [FundingBody.from_dict(_item) for _item in obj["funder"]] if obj.get("funder") is not None else None
        })
        return _obj
