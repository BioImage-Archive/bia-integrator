...
class PrivateApi:
    ...
    def fts(
        self,
        query: Annotated[str, Field(min_length=1, strict=True, max_length=500)],
    ...
    @validate_call
    def fts_without_preload_content(
        self,
        query: Annotated[str, Field(min_length=1, strict=True, max_length=500)],
        _request_timeout: Union[
            None,
