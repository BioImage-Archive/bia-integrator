...
from bia_export.website_export.galleries.models import (
    Gallery_Dataset,
    Gallery_Study,
    GalleryCLIContext,
    CacheUse
)
from bia_export.website_export.galleries.retrieve import (
    retrieve_study,
...
def transform_gallery_study(context: GalleryCLIContext) -> Gallery_Study:
    ...
    study = Gallery_Study(**study_dict)
    return study


def transform_datasets(
    context: GalleryCLIContext,
) -> List[Gallery_Dataset]:
...
def transform_dataset(
    ...
    dataset = Gallery_Dataset(**dataset_dict)
    return dataset


def transform_dataset_detail_objects(
    dataset: api_models.Dataset, context: GalleryCLIContext
):
