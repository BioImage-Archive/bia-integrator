...
from .models import GalleryCLIContext, CacheUse
...
def retrieve_study(context: GalleryCLIContext) -> api_models.Study:
...
def retrieve_aggregation_fields(
    dataset: bia_data_model.DocumentMixin, context: GalleryCLIContext
):
...
def aggregate_file_list_data(context: GalleryCLIContext) -> None:
